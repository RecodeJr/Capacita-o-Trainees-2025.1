function result(valor, unidade) {
  document.getElementById(
    "resultado"
  ).textContent = `Resultado: ${valor} ${unidade}`;
}
...
function comprimento(de, valor, para) {
  ...
  if (de === "cm") {
    resultado =
      para === "m" ? valor / 100 : para === "km" ? valor / 100000 : valor;
  } else if (de === "m") {
    resultado =
      para === "cm" ? valor * 100 : para === "km" ? valor / 1000 : valor;
  } else if (de === "km") {
    resultado =
      para === "cm" ? valor * 100000 : para === "m" ? valor * 1000 : valor;
  }
...
document
  .getElementById("comprimentovalor")
...
document
  .getElementById("comprimentoresultado")
  .addEventListener("change", function () {
...
document
  .getElementById("temperaturavalor")
  .addEventListener("change", function () {
    const de = this.value;
...
document
  .getElementById("temperaturarresultado")
  .addEventListener("change", function () {
    const para = this.value;
